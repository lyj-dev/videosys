...
<header>
    <div class="container">
        ...
        <a class="color_e4"><img src="../img/phone.png" draggable="false"> 0375-208-9092&#x3000;&#x3000;0375-208-9051</a>

    </div>
</header>
<nav class="w100">
    <div class="container">
        <img src="../img/logo.png" alt="Y先生教育的logo" onclick="location.href='${pageContext.request.contextPath}/before/index.jsp'" draggable="false">
        <ul class="text_13 f_right">
            ...
            <li class="nav_down">
                ...
                <ul id="nav_down" class="t_center">
                    ...
                    <li>
                        <a target="_blank" href="#">大数据</a>
                    </li>
                    <li>
                        <a target="_blank" href="#">信息安全</a>
                    </li>
                    <li>
                        <a target="_blank" href="#">APP UI</a>
                    </li>
                    <li>
    ...
    <div class="container">
        ...
        <div class="course-info">
            <table cellspacing="10">
                <tr>
                    <td colspan="2">
                        <a href="${pageContext.request.contextPath}/subject/query.do?id=1">
...
<div class="mask hidden" id="reg">
    <div class="mask_content">
        ...
        <div class="mask_content_body">
            <form id="regForm" action="../user/insert.do">
                <h3>新用户注册</h3>
