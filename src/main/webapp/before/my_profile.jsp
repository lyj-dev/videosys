        ...
        <menu>
            <div class="container clearfix">
                <ul class="clearfix f_left">
                    ...
                    <li><a href="${pageContext.request.contextPath}/before/index.jsp">课程</a></li>
                    <li><a href="#">关于我们</a></li>
                ...
                <div id="user_bar">
                    ...
                    <a href="${pageContext.request.contextPath}/user/logout.do" id="lay_out">退出</a>
                </div>
            </div>
        </menu>
    </header>
                ...
                <div class="proflle_tab_body">
                    ...
                    <div class="proflle_tab_workplace clearfix">
                        ...
                        <ul class="profile_ifo_area">
                            ...
                            <li><span class="dd">生&#x3000;日：</span>${user.birthdayStr}</li>
