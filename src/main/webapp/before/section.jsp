    ...
    <nav class="w100">
        <div class="container">
            ...
            <ul class="text_13 f_right">
                <li>
                    <a href="${pageContext.request.contextPath}/before/index.jsp" target="_blank">首页</a>
                </li>
                <li class="nav_down">
                    ...
                    <ul id="nav_down" class="t_center">
                        ...
                        <li>
                            <a target="_blank" href="http://www.chengjisn100.com/IS/index.html">信息安全</a>
                        </li>
                        <li>
                    ...
                    <div class="v-intro">
                        <div class="left">
                            <video id="videoPlayer" src="${video.videoUrl}" class="video-js vjs-default-skin" controls width="627" height="280"
                                poster="${video.imgUrl}" data-setup="{}">
                            </video>
                        </div>
                        ...
                        <div class="right">
                            ...
                            <div class="avatar">
                                ...
                                <p><b>讲师：${speaker.name}</b><br><i>${speaker.desc}</i></p>
                            </div>
                            <p class="video-intro">
                ...
                <div class="container">
                    ...
                    <c:forEach items="${course.videoList}" var="video" >
	                    <div class="chapter"  onclick="load(${video.id})">
	                        <p class="biaoti"><a href="${pageContext.request.contextPath}/video/showVideo?videoId=${video.id}&subjectName=${subjectName}">${video.title}</a></p>
	                        <p class="lecturer">${video.detail}</p>
	                        <p class="lecturer">讲师：${video.speaker}</p>
	                        <div class="v-info">
...
<%-- 
    ...
    <script type="text/javascript">
	    $("#loginout2").click(function(){
	        ...
	        $.get("${pageContext.request.contextPath}/user/loginout.do",null,function(){
	             /* $("#regBlock").css("display","block");
	             $("#userBlock").css("display","none"); */
