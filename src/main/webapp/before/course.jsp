...
<header>
    <div class="container">
        ...
        <div id="userBlock" style="display:none;float:right">
            ...
            <a href="javascript:logout();" id="loginout">退出</a>
...
<nav class="w100">
    <div class="container">
        <img src="${pageContext.request.contextPath}/img/logo.png" alt="Y先生教育的logo" onclick="location.href='${pageContext.request.contextPath}/before/index.jsp'" draggable="false">
        <ul class="text_13 f_right">
            <li>
                <a href="${pageContext.request.contextPath}/before/index.jsp" >首页</a>
            </li>
            <li class="nav_down">
                高端课程<img src="${pageContext.request.contextPath}/img/nav_down.png" alt="" draggable="false">
                <ul id="nav_down" class="t_center">
                    <li>
                        <a target="_blank" href="http://www.chengjian100.com/Java/index.html">Java国际</a>
                    </li>
                    <li>
                        <a target="_blank" href="http://www.chengjian100.com/vr/index.html">VR</a>
                    </li>
                    <li>
                        <a target="_blank" href="http://www.chengjian100.com/html5/index.html">HTML5</a>
                    </li>
                    <li>
                        <a target="_blank" href="http://www.chengjian100.com/bigdata/index.html">大数据</a>
                    </li>
                    <li>
                        <a target="_blank" href="http://www.chengjian100.com/IS/index.html">信息安全</a>
                    </li>
                    <li>
                        <a target="_blank" href="http://www.chengjian100.com/appui/index.html">APP UI</a>
                    </li>
                    <li>
                        <a target="_blank" href="http://www.chengjian100.com/php/index.html">PHP</a>
                    </li>
                    <li>
                        <a target="_blank" href="http://www.chengjian100.com/python/index.html">Python</a>
                    </li>
                    <!--<li>
                        <a target="_blank" href="http://www.chengjian100.com/Android/index.html">Android</a>
                    </li>-->
                    <li>
                        <a target="_blank" href="http://www.chengjian100.com/ios/index.html">iOS</a>
                    </li>
                    <!--<li>
                        <a target="_blank" href="http://www.chengjian100.com/netop/index.html">网络运营</a>
                    </li>-->
                </ul>
            </li>
...
<div id="app" >
    ...
    <!--面包屑导航-->
    <div class="container mian-nav">Web课 / ${subject.name}</div>
            ...
            <c:forEach items="${subject.courseList}" var="course">
                <div class="section" >
                    <div class="classifyName">
                        <p class="title title-first">${course.title}</p>
                    </div>
                    <div class="kcIntro">
                        <p class="int"><span>课程介绍：</span>${course.desc}
                        </p>
                    </div>
                    <ul>
                        <!--节-->
                        <c:forEach items="${course.videoList}" var="video" varStatus="i" >
                            <li class="section-main"  onclick="getVideo(${video.id})">
                                <div class="thum" style="background-image: url('${video.imgUrl}')">
    ...
    <div class="mask_content">
        ...
        <div class="mask_content_body">
            <form id="loginForm" action="#">
                ...
                <div id="forget">
                    <a href="${pageContext.request.contextPath}/before/forget_password.jsp">忘记密码？</a>
...
<div class="mask hidden" id="reg">
    <div class="mask_content">
        ...
        <div class="mask_content_body">
            <form id="regForm" action="${pageContext.request.contextPath}/user/insert.do">
                <h3>新用户注册</h3>
...
<script type="text/javascript">
    ...
    function getVideo(videoId){
        ...
        if((null!="${sessionScope.userAccount}" && "${sessionScope.userAccount}" !="") || ($("#isLogin").val()==1)){
            //如果登录
            location.href="${pageContext.request.contextPath}/video/showVideo?videoId="+videoId+"&subjectName="+'${subject.name}';
        }else{
            //如果不登录，弹登录框
