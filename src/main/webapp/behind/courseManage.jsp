...
<div style="height: 70px;text-align: center; background-color: #C8EBFA;">
    <h1 style="text-align: center;padding-top: 20px">课程管理</h1>
</div>
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'desc', title:'介绍',  edit: 'text', width: 600}
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                layer.open({
                    ...
                    , title: '修改课程信息'
                    , area: ['500px', '500px']
                    , content: '../course/query.do?id=' + data.id
